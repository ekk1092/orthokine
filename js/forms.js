...
(function() {
  function initForms() {
    ...
    document.getElementById("calendar-therapist-filter").addEventListener("change", () => {
      ...
      if (filterVal === "all") {
        filterBadge.textContent = OrthoKine.translations.filter_all_therapists[store.lang] || "Tous les thérapeutes";
      } else {
  ...
  function openPatientModal(id = null) {
    ...
    if (id) {
      ...
      title.textContent = OrthoKine.translations.modal_patient_new[store.lang] || "Enregistrer Nouveau Patient";
  ...
  function openAppointmentModal(id = null, defaultDate = null) {
    ...
    if (id) {
      ...
      title.textContent = OrthoKine.translations.modal_apt_new[store.lang] || "Planifier Nouveau RDV";
